    ...
    return (
      <div className={ this.props.portfolio[index].net_gain >= 0 ? 'green-stock' : 'red-stock' }>
        ...
        <Accordion.Content active={activeIndex === index}>
          <p>
           Net Gain: {this.props.portfolio[index].net_gain} <br />
           Number of Shares: {this.props.portfolio[index].number_of_shares} <br />
           Position Exposure: {this.props.portfolio[index].total_cost} <br />
           Last Trade Time: {this.props.portfolio[index].time_of_last_event} <br />
          </p>
        </Accordion.Content>
      </div>
    );
